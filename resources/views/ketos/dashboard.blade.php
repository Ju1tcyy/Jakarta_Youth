...
<head>
    ...
    <title>Dashboard Ketos - {{ config('app.name', 'Jakarta Youth Achievement Award') }}</title>
    ...
    <div class="header">
        <div class="logo">
            <img src="{{ asset('icon/logo collab.png') }}" alt="Jakarta Youth Achivement Award  Logo">
        ...
        <div class="content-area">
            ...
            <div id="dashboard" class="content-section active">
                ...
                <div class="text-center mb-6">
                    <img src="{{ asset('icon/logo_collab.png') }}" alt="Jakarta Youth Achivement Award  Logo" style="height: 60px; width: auto; margin: 0 auto 15px;">
