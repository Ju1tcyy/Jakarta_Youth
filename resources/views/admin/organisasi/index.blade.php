...
@section('page-title', 'Data Pendaftaran Organisasi')
                        ...
                        <table class="min-w-full divide-y divide-gray-200 dark:divide-gray-700">
                            <thead class="bg-gray-50 dark:bg-gray-700">
                                <tr>
                                    ...
                                    <th class="px-6 py-3 text-left text-xs font-medium text-gray-500 dark:text-gray-300 uppercase tracking-wider">Nama Sekolah</th>
                                    <th class="px-6 py-3 text-left text-xs font-medium text-gray-500 dark:text-gray-300 uppercase tracking-wider">Nama Organisasi</th>
                            ...
                            <tbody class="bg-white dark:bg-gray-800 divide-y divide-gray-200 dark:divide-gray-700">
                                @forelse($organisasi as $index => $item)
                                    <tr>
                                        <td class="px-6 py-4 whitespace-nowrap text-sm">{{ $organisasi->firstItem() + $index }}</td>
                                        <td class="px-6 py-4 whitespace-nowrap text-sm">{{ $item->nama_sekolah }}</td>
                                        <td class="px-6 py-4 whitespace-nowrap text-sm">{{ $item->nama_organisasi }}</td>
                                        <td class="px-6 py-4 whitespace-nowrap text-sm">{{ $item->email_organisasi }}</td>
                                        ...
                                        <td class="px-6 py-4 whitespace-nowrap text-sm">
                                            <a href="{{ route('sekolah.show', $item->id) }}" class="text-blue-600 hover:text-blue-900 mr-3">Detail</a>
