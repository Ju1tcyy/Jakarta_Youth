        ...
        @foreach($nominationStats as $key => $nomination)
            <div class="bg-white rounded-[30px] p-6 shadow-sm border border-slate-100 hover:shadow-xl hover:-translate-y-1 transition-all duration-300 group">
                <div class="flex items-center justify-between mb-6">
                    ...
                    <a href="{{ route('sekolah.index', ['kategori' => $key]) }}" class="w-8 h-8 bg-slate-50 rounded-lg flex items-center justify-center text-slate-400 group-hover:text-blue-500 group-hover:bg-blue-50 transition-colors" title="Lihat Pendaftar Kategori Ini">
