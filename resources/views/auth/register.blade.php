    ...
    <div class="space-y-12 animate-fade-up">
        <div class="text-center space-y-10">
            <div class="space-y-4">
                ...
                <p class="text-slate-500 font-bold text-xs uppercase tracking-[0.3em]">Pilih kategori pendaftaran Anda:
                </p>
            </div>
            ...
            <div class="bg-slate-50 p-2 rounded-3xl flex items-center max-w-sm mx-auto border-2 border-slate-100 shadow-sm relative overflow-hidden"
                x-data="{ 
                    currentRole: new URLSearchParams(window.location.search).get('role') || '{{ old('role', 'organisasi') }}',
                    init() {
        ...
        <form method="POST" action="{{ route('register') }}" class="space-y-10" id="registrationForm">
            ...
            <input type="hidden" name="role" id="role_input" value="{{ request('role', old('role', 'organisasi')) }}">

            <!-- Account Credentials -->
            <div class="space-y-8">
                <div class="flex items-center gap-4">
                    <span
                        class="text-[10px] font-black text-slate-300 uppercase tracking-[0.5em] whitespace-nowrap">Kredensial
                        Akun</span>
                ...
                <div class="space-y-4 group">
                    <label for="email"
                        class="text-[11px] font-black text-slate-400 uppercase tracking-[0.4em] ml-1 group-focus-within:text-primary transition-colors">Alamat
                        Email</label>
                    <div class="relative">
                        ...
                        <div
                            class="absolute left-6 top-1/2 -translate-y-1/2 text-slate-400 group-focus-within:text-primary transition-colors">
                ...
                <div class="grid grid-cols-1 sm:grid-cols-2 gap-8">
                    <div class="space-y-4 group">
                        <label for="password"
                            class="text-[11px] font-black text-slate-400 uppercase tracking-[0.4em] ml-1 group-focus-within:text-primary transition-colors">Kata
                            Sandi</label>
                        <div class="relative">
                    ...
                    <div class="space-y-4 group">
                        <label for="password_confirmation"
                            class="text-[11px] font-black text-slate-400 uppercase tracking-[0.4em] ml-1 group-focus-within:text-primary transition-colors">Konfirmasi</label>
                        <div class="relative">
            ...
            <div id="dynamic_fields_container" class="space-y-8 animate-fade-up delay-100">
                <div class="flex items-center gap-4">
                    <span
                        class="text-[10px] font-black text-slate-300 uppercase tracking-[0.5em] whitespace-nowrap">Informasi
                        Profil</span>
                    <div class="h-px w-full bg-slate-100"></div>
                </div>
                ...
                <div id="ketos_fields" class="space-y-8 hidden">
                    <div class="group space-y-4">
                        <label for="name"
                            class="text-[11px] font-black text-slate-400 uppercase tracking-[0.4em] ml-1 group-focus-within:text-primary transition-colors">Nama
                            Lengkap</label>
                        <div class="relative">
                    ...
                    <div class="group space-y-4">
                        <label for="asal_sekolah_ketos"
                            class="text-[11px] font-black text-slate-400 uppercase tracking-[0.4em] ml-1 group-focus-within:text-primary transition-colors">Asal
                            Sekolah</label>
                        <div class="relative">
                            <input id="asal_sekolah_ketos" type="text" name="asal_sekolah"
                ...
                <div id="organisasi_fields" class="space-y-8 hidden">
                    ...
                    <div class="group space-y-4">
                        <label for="asal_sekolah_org"
                            class="text-[11px] font-black text-slate-400 uppercase tracking-[0.4em] ml-1 group-focus-within:text-primary transition-colors">Asal
                            Sekolah</label>
                        <div class="relative">
                            <input id="asal_sekolah_org" type="text" name="asal_sekolah"
                                value="{{ old('asal_sekolah') }}"
                                class="w-full px-14 py-6 bg-slate-50 border-2 border-slate-100 rounded-3xl focus:bg-white focus:border-primary focus:ring-4 focus:ring-primary/5 transition-all text-sm font-black text-primary placeholder:text-slate-300"
                    ...
                    <div class="group space-y-4">
                        <label for="nama_perwakilan_1"
                            class="text-[11px] font-black text-slate-400 uppercase tracking-[0.4em] ml-1 group-focus-within:text-primary transition-colors">Nama
                            Perwakilan 1 <span class="text-primary">(Wajib)</span></label>
                        <div class="relative">
                            <input id="nama_perwakilan_1" type="text" name="nama_perwakilan_1"
                                value="{{ old('nama_perwakilan_1') }}"
                                class="w-full px-14 py-6 bg-slate-50 border-2 border-slate-100 rounded-3xl focus:bg-white focus:border-primary focus:ring-4 focus:ring-primary/5 transition-all text-sm font-black text-primary placeholder:text-slate-300"
                                placeholder="Nama Lengkap Perwakilan 1">
                            <div
                                class="absolute left-6 top-1/2 -translate-y-1/2 text-slate-400 group-focus-within:text-primary transition-colors">
                                <i data-feather="user" class="w-5 h-5"></i>
                            </div>
                    ...
                    <div class="group space-y-4">
                        <label for="nama_perwakilan_2"
                            class="text-[11px] font-black text-slate-400 uppercase tracking-[0.4em] ml-1 group-focus-within:text-primary transition-colors">Nama
                            Perwakilan 2 <span
                                class="text-slate-400 normal-case tracking-normal font-medium">(Opsional)</span></label>
                        <div class="relative">
                            <input id="nama_perwakilan_2" type="text" name="nama_perwakilan_2"
                                value="{{ old('nama_perwakilan_2') }}"
                                class="w-full px-14 py-6 bg-slate-50 border-2 border-slate-100 rounded-3xl focus:bg-white focus:border-primary focus:ring-4 focus:ring-primary/5 transition-all text-sm font-black text-primary placeholder:text-slate-300"
                                placeholder="Nama Lengkap Perwakilan 2">
                            <div
                                class="absolute left-6 top-1/2 -translate-y-1/2 text-slate-400 group-focus-within:text-primary transition-colors">
                                <i data-feather="user" class="w-5 h-5"></i>
                            </div>
