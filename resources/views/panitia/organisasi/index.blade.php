...
<div class="mb-6 flex justify-between items-center">
    <p class="text-slate-500 font-medium ml-1">Laman pantauan khusus Panitia untuk verifikasi pendaftar.</p>
</div>
                    ...
                    <tr class="hover:bg-slate-50/50 transition-colors group">
                        ...
                        <td class="px-6 py-4 text-right">
                            <div class="flex justify-end items-center space-x-2">
                                <a href="{{ route('panitia.sekolah.show', $item->id) }}" class="w-8 h-8 flex items-center justify-center bg-blue-50 text-blue-600 rounded-xl hover:bg-blue-600 hover:text-white transition-all shadow-sm" title="Lihat Detail">
